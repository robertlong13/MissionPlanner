            ...
            if (Control != null)
            {
                ...
                if (Control.PolygonsEnabled)
                {
                    ...
                    foreach (GMapPolygon r in Polygons.ToArray())
                    {
                        ...
                        if (r.Bounds.Right < viewarea.Left ||
                            r.Bounds.Top < viewarea.Bottom ||
                            r.Bounds.Left > viewarea.Right ||
                            r.Bounds.Bottom > viewarea.Top)
                        {  
                            continue;
                        }
                    ...
                    //Console.WriteLine("rendered " + Id + " "  +b + " polygons");
                }
